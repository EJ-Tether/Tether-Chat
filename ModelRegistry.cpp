...
void ModelRegistry::populateModels() {
    ...
    m_models.append({"OpenAI", "GPT-4o", "chatgpt-4o-latest",
                     "https://api.openai.com/v1/responses", 100000, 85000});
    m_models.append({"OpenAI", "GPT-4 Turbo", "gpt-4-turbo",
                     "https://api.openai.com/v1/responses", 22000, 12000});
    m_models.append({"OpenAI", "GPT-3.5 Turbo", "gpt-3.5-turbo",
                     "https://api.openai.com/v1/responses", 12000,
                     8000}); // Lower for 3.5
    m_models.append({"OpenAI", "GPT-5.1", "gpt-5.1",
                     "https://api.openai.com/v1/responses", 150000, 12000});
    ...
    m_models.append({"OpenAI", "GPT-4.1 (long context)", "gpt-4.1",
                     "https://api.openai.com/v1/responses", 90000, 70000});
#ifdef _GEMINI_ // TBD to unlock when Gemini API will be tested/debugged
