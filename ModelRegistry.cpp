...
void ModelRegistry::populateModels() {
    ...
    m_models.append({"OpenAI", "GPT-5", "gpt-5", "https://api.openai.com/v1/responses"});
    m_models.append({"OpenAI", "GPT-5 mini", "gpt-5-mini", "https://api.openai.com/v1/responses"});
    m_models.append({"OpenAI", "GPT-5 nano", "gpt-5-nano", "https://api.openai.com/v1/responses"});
