...
void ModelRegistry::populateModels() {
    ...
    m_models.append({"OpenAI", "GPT-4o", "gpt-4o", "https://api.openai.com/v1/responses"});
    m_models.append({"OpenAI", "GPT-4 Turbo", "gpt-4-turbo", "https://api.openai.com/v1/responses"});
    m_models.append({"OpenAI", "GPT-3.5 Turbo", "gpt-3.5-turbo", "https://api.openai.com/v1/responses"});
    m_models.append({"OpenAI", "GPT-5.1", "gpt-5.1", "https://api.openai.com/v1/responses"});
    m_models.append({"OpenAI", "GPT-5.1 mini", "gpt-5.1-mini", "https://api.openai.com/v1/responses"});
    m_models.append({"OpenAI", "GPT-5.1 nano", "gpt-5.1-nano", "https://api.openai.com/v1/responses"});
    m_models.append({"OpenAI", "GPT-4.1 (long context)", "gpt-4.1", "https://api.openai.com/v1/responses"});
